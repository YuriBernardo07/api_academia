...
class Produto(Base):
    ...
    def __init__(self, nome:str, matricula:int, mensalidade:float,
        ...
        Arguments:
            ...
            matricula: matricula que se espera comprar daquele produto
            mensalidade: mensalidade esperado para o produto
